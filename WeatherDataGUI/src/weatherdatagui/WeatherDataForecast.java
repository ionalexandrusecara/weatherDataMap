...
public class WeatherDataForecast {
    ...
    public WeatherDataForecast(int n) {
    }

    public static void processData() {
        WeatherDataCurrentWeather client = new WeatherDataCurrentWeather(1);
    ...
    static JLabel city = new JLabel("City Name: ");
    static TextField cityName = new TextField();
    static JLabel country = new JLabel("Country Dode: ");
    static TextField countryCode = new TextField();
    ...
    private static void showJFrameDemo() {
        city.setBounds(50, 50, 100, 20);
        city.setForeground(Color.WHITE);
        city.setFont(new Font("Tahoma", Font.BOLD, 12));
        cityName.setBounds(160, 50, 150, 20);

        country.setBounds(50, 100, 100, 20);
        country.setForeground(Color.WHITE);
        country.setFont(new Font("Tahoma", Font.BOLD, 12));
        countryCode.setBounds(160, 100, 150, 20);
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                userCity = cityName.getText();
                userCountryCode = countryCode.getText();
                processData();
                //mainFrame.dispose();
            }
        });
        ...
        mainFrame.add(city);
        mainFrame.add(cityName);
        mainFrame.add(country);
        mainFrame.add(countryCode);
    ...
    public static boolean checkCity() {
        if (userCity.equals("")) {
            JOptionPane.showMessageDialog(null, "City Field is null!");
            return false;
        }
        return true;
    }
    ...
    public static boolean checkCountryCode() {
        if (userCountryCode.equals("")) {
            JOptionPane.showMessageDialog(null, "Country Code field is null!");
            return false;
        }
        return true;
    }
